<?php
// inserting the data when clicking submit
if (isset($_POST['submit'])) {
    ...
    // checking if the service provider does not have an entry in the database
    $results = $wpdb->get_results("select * from ServiceProviders Where ABNNo='" . $abn . "' OR LoginEmail='" . $LoginEmail . "'");
    if (count($results) > 0) {
        ...
        // sending an email to the admin about the new registeration
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="user-registration ur-frontend-form" id="user-registration-form-5914">
            ...
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>Avg. no. of certifications/annum </b><abbr class="required" title="required">*</abbr><input type="number" id="ACA" required name="AverageOfYearlyCert">
                    </div>
                    <div>
        ...
        <div class="user-registration ur-frontend-form" id="user-registration-form-5914">
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <table border="1">
                        <tr>
                            <td colspan="2" id="CP"><b>Credentials Setup: <abbr class="required" title="required">*</abbr></b></td>
                        </tr>
                        <tr>
                            <td><input id="LoginEmail" type="email" name="LoginEmail" placeholder="E-mail to be used for login" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input id="confirmPassword" type="password" placeholder="Confirm password" required oninput="validatePasswordMatch()"></td>
                        </tr>
                    </table>
        ...
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                <input type="checkbox" id="Demo" name="Demo" required oninput="demo()"><b>By signing up I agree to the <a href="https://icertify.net.au/service-provider/term-and-conditions_service-providers/" style="color:#2271b1;" rel="attachment wp-att-7520" target="_blank">terms of service and privacy policy.</a></b><abbr class="required" title="required">*</abbr>
                <!--storing the lists input in a hidden inputs to save them to the database!-->
