...
<div id="user-registration-form-5882" class="user-registration ur-frontend-form  ">
    <form method="post" action="https://icertify.net.au/?page_id=5913">
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                Organisation Name<input oninput="mynewfunction()" type="text" id="ON" name="OrganisationName"
                    required><br>
        ...
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                Mobile (+XX XXX XXX XXX)<input type="text" pattern="\+[0-9]{2}\s[0-9]{3}\s[0-9]{3}\s[0-9]{3}" id="MOB"
                    required name="Mobile"><br>
                Telphone (XX X XXXX XXXX)<input type="text" pattern="[0-9]{2}\s[0-9]{1}\s[0-9]{4}\s[0-9]{4}" id="TEL"
                    required name="Telephone"><br>
            </div>
        </div>
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
        ...
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                No. of physical locations within Aus<input type="number" min="1" id="LIA" required
                    name="NoOfPhysicalLocationsInAus"><br>
                No. of physical locations outside Aus<input type="number" min="1" id="AOA" required
                    name="NoOfPhysicalLocationsOutAus"><br>
            </div>
        </div>
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                <div class="ur-field-item field-checkbox">
                    <table class="checkbox" border="1">
                        <tr>
                            <td colspan="2" id="CP"> <b><u> Select Certifications Provided:<abbr class="required"
                                            title="required">*</abbr> </u></b></td>
                ...
                <div id="radio_1598611551_field" class="form-row validate-required" data-priority="">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="OTH" class="input-radio ur-frontend-field"
        ...
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                <input type="checkbox" id="Demo" name="Demo" required oninput="demo()">Terms and Conditions<abbr
