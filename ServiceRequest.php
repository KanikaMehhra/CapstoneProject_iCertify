...
<div id="user-registration-form-5882" class="user-registration ur-frontend-form  ">
    <form method="post" enctype="multipart/form-data" action="https://icertify.net.au/buyers-request/request-form/request-complete/">
        ...
        <div class="ur-form-row">
            <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                <input type="checkbox" id="Demo" name="Demo" required oninput="demo()"><b>By signing up I agree to the <a href="https://icertify.net.au/buyers-request/term-and-conditions_buyers/" rel="attachment wp-att-7517" style="color:#2271b1;" target="_blank">terms and conditions.</a></b><abbr class="required" title="required">*</abbr>
                <!-- getting the values of the lists into hidden inputs to save them to the database !-->
...
<script>
    ...
    // user cannot select any previous date
...
if (isset($_POST['submit'])) {
    ...
    // sending an email to the client about the new request
    $msg = "Hi, \n\nA new Service Request has been made.";
    wp_mail("inquiries@icertify.net.au", "New Service Request!", $msg);
    header('Location: https://icertify.net.au/buyers-request/request-form/request-complete/');
    die;
}
?>