...
<div class="user-registration ur-frontend-form" id="user-registration-form-5914">
    ...
    <div id="user-registration-form-5882" class="user-registration ur-frontend-form  ">
        <form class="information" method="post" onsubmit="formSubmission1();return false;">
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>Organisation Name </b><input type="text" id="ON" name="OrganisationName" value="<?php echo $_SESSION['OrganisationName']; ?>">
                    </div>
                    <div>
                        <b>Contact Name </b><input type="text" id="CN" name="ContactName" value="<?php echo $_SESSION['ContactName']; ?>">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>Position Title </b><input type="text" id="PT" name="PositionTitle" value="<?php echo $_SESSION['PositionTitle']; ?>">
                    </div>
                    <div>
                        <b>Number of employees </b><input type="number" id="NOE" name="NoOfEmployees" min="1" value="<?php echo $_SESSION['NoOfEmployees']; ?>">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>ABN/ACN </b><input type="number" id="ABN" value="<?php echo $_SESSION['ABNNo']; ?>" name="ABNNo" oninput="validateABN()"><label style="color:#FF0000;" id="errorLabel1"></label>
                    </div>
                    <div>
                        <b>E-mail </b><input type="email" id="EMAIL" value="<?php echo $_SESSION['ContactEmail']; ?>" name="ContactEmail">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>Mobile (+XX XXX XXX XXX) </b><input type="text" pattern="\+[0-9]{2}\s[0-9]{3}\s[0-9]{3}\s[0-9]{3}" id="MOB" name="Mobile" value="<?php echo $_SESSION['Mobile']; ?>">
                    </div>
                    <div>
                        <b>Telphone (+XX X XXXX XXXX) </b><input type="text" pattern="\+[0-9]{2}\s[0-9]{1}\s[0-9]{4}\s[0-9]{4}" id="TEL" value="<?php echo $_SESSION['Telephone']; ?>" name="Telephone">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>Head office location </b><input type="text" id="HOL" value="<?php echo $_SESSION['HeadOfficeAddress']; ?>" name="HeadOfficeAddress">
                    </div>
                    <div>
                        <b>Avg. no. of certifications/annum </b><input type="number" id="ACA" value="<?php echo $_SESSION['AverageOfYearlyCert']; ?>" name="AverageOfYearlyCert">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div>
                        <b>No. of physical locations within Australia </b><input type="number" min="1" id="LIA" value="<?php echo $_SESSION['NoOfPhysicalLocationsInAus']; ?>" name="NoOfPhysicalLocationsInAus">
                    </div>
                    <div>
                        <b>No. of physical locations outside Australia</b><input type="number" id="AOA" value="<?php echo $_SESSION['NoOfPhysicalLocationsOutAus']; ?>" name="NoOfPhysicalLocationsOutAus">
                    </div>
                </div>
            </div>
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div class="ur-results-item results-checkbox">
                        <table class="checkbox">
                            ...
                            <tr>
                                <td>Quality</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Quality" name="CertificationsProvided" value="Quality"></td>
                            </tr>
                            <tr>
                                <td>Workplace Health And Safety</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Workplace Health And Safety" name="CertificationsProvided" value="Workplace Health And Safety"></td>
                            </tr>
                            <tr>
                                <td>Environmental Sustainability</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Environmental Sustainability" name="CertificationsProvided" value="Environmental Sustainability"></td>
                            </tr>
                            <tr>
                                <td>Sourcing Practices</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Sourcing Practices" name="CertificationsProvided" value="Sourcing Practices"></td>
                            </tr>
                            <tr>
                                <td>Supply Chain Monitoring</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Supply Chain Monitoring" name="CertificationsProvided" value="Supply Chain Monitoring"></td>
                            </tr>
                            <tr>
                                <td>Energy Management</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Energy Management" name="CertificationsProvided" value="Energy Management"></td>
                            </tr>
                            <tr>
                                <td>Corporate Social Responsibility</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Corporate Social Responsibility" name="CertificationsProvided" value="Corporate Social Responsibility"></td>
                            </tr>
                            <tr>
                                <td>Sustainability Reporting</td>
                                <td><input oninput="checkedCheckbox()" type="checkbox" id="Sustainability Reporting" name="CertificationsProvided" value="Sustainability Reporting"></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <div class="ur-results-item results-checkbox">
                        <table class="checkbox">
                            ...
                            <tr>
                                <td>Remote audit</td>
                                <td><input type="checkbox" id="Remote audit" name="AdditionalServices" value="Remote audit"></td>
                            </tr>
                            <tr>
                                <td>Gap audit</td>
                                <td><input type="checkbox" id="Gap audit" name="AdditionalServices" value="Gap audit">
                                </td>
                            </tr>
                            <tr>
                                <td>Other services</td>
                                <td><input type="text" id="OTH" name="AdditionalServices"></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="ur-form-row">
                <div class="ur-form-grid ur-grid-1" style="width: 48%;">
                    <input required type="checkbox" id="Demo" name="Demo" oninput="demo()"><b>By signing up I agree to
                            ...
                            <div class="ur-field-item field-radio " data-field-id="radio_1598611551">
                                <div id="radio_1598611551_field" class="form-row validate-required" data-priority="">
                                    ...
                                    <ul class="pricingPreference">
                                        ...
                                        <li><input id="pricingFixedTextBox" oninput="checkBaseHourlyRate()" type="number" placeholder="Enter hourly rate (AUD)" disabled /></li>
                        ...
                        <div class="ur-form-grid ur-grid-1" style="width:99%">
                            <div>
                                <div class="ur-button-container ">
                                    <div onclick="validateSubmit()">
                                        <div onclick="checkPricing()">
                                            <div onclick="checkUpload()">
                                                <input value="Save" id="submit" name="save" type="submit" onclick="saveAndLogout()">
...
<script>
    // var orgName = document.getElementById('ON').value;
    // var conName = document.getElementById('CN').value;
...
if (isset($_POST['save'])) {
    ...
    $ContactName = "<script type=\"text/javascript\">   
                            alert(sessionStorage.getItem('ContactName'));                
                            document.write(sessionStorage.getItem('ContactName'));
                         </script>";
    $data = array(
